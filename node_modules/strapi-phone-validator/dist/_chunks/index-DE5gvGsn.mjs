...
import { Field, Flex, Typography, FieldHint, FieldError } from "@strapi/design-system";
...
const Input = (props) => {
  ...
  const handlePhoneChange = async (phoneNr) => {
    setPhone(phoneNr);
    props.onChange({
      target: {
        name: props.name,
  ...
  return /* @__PURE__ */ jsx(
    Field,
    {
      ...
      children: /* @__PURE__ */ jsxs(Flex, { gap: "4px", flexDirection: "column", wrap: "wrap", alignItems: "stretch", children: [
        ...
        /* @__PURE__ */ jsx(
          PhoneInput,
          {
            ...
            inputStyle: {
              ...mainStyles,
              width: "100%",
              borderColor: !isValid ? "#d02b20 #d02b20 #d02b20 #dcdce4" : "#dcdce4",
            ...
            countrySelectorStyleProps: {
              ...
              buttonStyle: {
                ...mainStyles,
                borderColor: !isValid ? "#d02b20 #dcdce4 #d02b20 #d02b20" : "#dcdce4",
        ...
        !isValid && /* @__PURE__ */ jsx(Typography, { variant: "pi", textColor: "danger700", children: "This is an invalid phone number" }),
...
//# sourceMappingURL=index-DE5gvGsn.mjs.map
